...
public class StringInMemory {
    ...
    public void test5(){// 测试不能通过
        ...
        String s2 = "hel";
        String s3 = "lo";
        String s4 = s2 + s3;  //底层实现方式，new StringBuilder().append().toString()
    ...
    public void test6(){//false
        String s = new StringBuilder("计算机").append("软件").toString(); //计算ji,ruanjian,tostring,StringBuilder
    ...
    public void test7_1(){//false
        ...
        Assert.assertTrue("计算机软件" == s.intern());//true,s.intern
